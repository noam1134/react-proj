...
const Main = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        hospitalId = sessionStorage.getItem('user').hospitalId;
        const response = await fetch(`https://localhost:7115/api/HospitalManager/GetAllHospitalManagersByHospitalId?hospitalId=${hospitalId}`);
